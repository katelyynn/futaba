...
export function SakuraPlaylist({ playlist }: { playlist: playlist }) {
  ...
  return (
    <Link href={`/playlist/${playlist.id}`} className={`${styles.playlist} ${visible && styles.visible}`} ref={ref}>
...
export function SakuraPlaylistSide({ playlist }: { playlist: playlist }) {
  ...
  return (
    <Link href={`/playlist/${playlist.id}`} className={`${styles.playlistSide} ${path.startsWith(`/playlist/${playlist.id}`) && styles.primary}`}>
